...
export const E_Pipe_Columns = [
  ...
  { field: "OBJECTID", text: "编号", width: 90, align: "center" },
  { field: "material_science", text: "材质", dom: "Select", sortable: true, align: "center" },
  ...
  { field: "Installation_address", text: "道路名", dom: "Select", sortable: true, align: "center" },
  { field: "construction_unit", text: "施工单位", dom: "Select", sortable: true, align: "center" },
  { field: "management_unit", text: "管理单位", dom: "Select", sortable: true, align: "center" },
  { field: "completion_date", text: "竣工日期", sortable: true, align: "center", dom: "Date" },
  ...
  { field: "embedding_mode", text: "埋设方式", dom: "Select", sortable: true, align: "center" },
  { field: "Interface_form", text: "接口形式", dom: "Select", sortable: true, align: "center" },
...
export const E_Valve_Columns = [
  ...
  { field: "Installation_address", text: "安装地址", dom: "Select", sortable: true, align: "center" },
  { field: "construction_unit", text: "管理单位", dom: "Select", sortable: true, align: "center" },
  { field: "completion_date", text: "竣工日期", sortable: true, align: "center", dom: "Date" },
  { field: "laying_age", text: "敷设年代", sortable: true, align: "center" },
  { field: "embedding_mode", text: "埋设方式", dom: "Select", sortable: true, width: 120, align: "center" },
  ...
  { field: "switch_type", text: "开关类型", dom: "Select", sortable: true, align: "center" },
  { field: "equipment_type", text: "设备类型", dom: "Select", sortable: true, align: "center" },
  { field: "switchingstate", text: "开关状态", dom: "Select", sortable: true, align: "center" },
  { field: "Interface_form", text: "接口形式", dom: "Select", sortable: true, align: "center" },
  { field: "businessarea", text: "营业片区", dom: "Select", sortable: true, align: "center" }
];
...
export const E_Exhaustvalve_Columns = [
  ...
  { field: "coordinate_y", text: "纵坐标", sortable: true, align: "center", type: "Number" },
  { field: "Interface_form", text: "接口形式", dom: "Select", sortable: true, align: "center" },
  { field: "specifications", text: "规格", dom: "Select", sortable: true, align: "center" },
  { field: "manufacturer", text: "生产厂家", dom: "Select", sortable: true, align: "center" },
  { field: "businessarea", text: "营业片区", dom: "Select", sortable: true, align: "center" }
];
...
export const Count_Attr = [
  { field: "length", text: "管长(km)", sortable: true, align: "center", type: 'Number', show: 'PipeLineLayer' },
...
export const Count_Material = [
  { field: "material_science", text: "材质", align: "center" },
  { field: "length", text: "管长(km)", sortable: true, align: "center", type: 'Number', show: 'PipeLineLayer' },
  { field: "equipment_number", text: "数目(个)", sortable: true, align: "center", type: 'Number' },
  { field: "lengthPercent", text: "管长比例", sortable: true, align: "center", type: 'Number', show: 'PipeLineLayer' },
  { field: "equipment_numberPercent", text: "数目比例", sortable: true, align: "center", type: 'Number' }
