      ...
      <el-row type="flex" justify="space-between">
        ...
        <el-col :span="12">
          <el-row type="flex" justify="end" style="padding:0">
            <el-button class="my-search" size="mini" @click="seniorSearch" v-if="$options.filters.btnTree('search' ,$route.meta.iFunID)">查询</el-button>
            <el-button class="my-reset" size="mini" @click="seniorReset" v-if="$options.filters.btnTree('reset' ,$route.meta.iFunID)">重置</el-button>
